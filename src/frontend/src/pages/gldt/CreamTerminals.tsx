        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
              ...
              />
              <span style={{ fontSize: 18, color: t.inkMid, fontWeight: 500 }}>
          ...
          >
            ...
            >
              <div style={{ fontWeight: 700, fontSize: 24, color: t.ink }}>
                GOLD SPOT
              </div>
              <div
                style={{
            ...
            >
              <div style={{ fontWeight: 700, fontSize: 24, color: t.goldDark }}>
                GLDT (IMPLIED)
              </div>
              <div
                style={{
            ...
            >
              <div style={{ fontWeight: 600, fontSize: 22, color: t.inkLight }}>
                SPREAD
              </div>
              <div
                style={{
          ...
          >
            <div style={{ fontSize: 14, color: t.footerText, fontWeight: 600 }}>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div style={{ fontWeight: 700, fontSize: 28, color: t.ink }}>
                VOLUME 7D
              </div>
              <div
                style={{
...
const PerformanceTerminal = forwardRef<HTMLDivElement, TerminalProps>(
  ({ data: d, theme = "cream" }, ref) => {
    ...
    const gridLine =
      theme === "dark" ? "rgba(255,255,255,0.04)" : "rgba(58,53,47,0.06)";
    const zeroLine =
      theme === "dark" ? "rgba(199,154,59,0.12)" : "rgba(199,154,59,0.2)";
    const axisLabel =
      theme === "dark" ? "rgba(255,255,255,0.25)" : "rgba(42,37,32,0.35)";
    const chartBg =
      theme === "dark" ? "rgba(255,255,255,0.03)" : "rgba(255,255,255,0.25)";
    const chartBorder =
      theme === "dark" ? "rgba(199,154,59,0.1)" : "rgba(58,53,47,0.1)";
    const labelColor = theme === "dark" ? "#f0e6d6" : t.ink;
    const subLabel =
      theme === "dark" ? "rgba(255,255,255,0.45)" : "rgba(42,37,32,0.5)";
    const gradId = theme === "dark" ? "gldtFillDark" : "gldtFillCream";

    // Card backgrounds
    const btcCardBg =
      theme === "dark" ? "rgba(247,147,26,0.06)" : "rgba(247,147,26,0.08)";
    const btcCardBorder =
      theme === "dark" ? "rgba(247,147,26,0.15)" : "rgba(247,147,26,0.2)";
    const gldtCardBg = t.greenBg;
    const gldtCardBorder = t.greenBorder;
    const icpCardBg =
      theme === "dark" ? "rgba(139,108,193,0.06)" : "rgba(139,108,193,0.08)";
    const icpCardBorder =
      theme === "dark" ? "rgba(139,108,193,0.15)" : "rgba(139,108,193,0.2)";

    // Static SVG chart paths (approximate representation)
    const gldtPath =
      "M70.0,275.6 L107.7,262.3 L145.5,256.5 L183.2,285.4 L220.9,247.8 L258.6,227.6 L296.4,218.9 L334.1,213.1 L371.8,198.7 L409.5,192.9 L447.3,184.2 L485.0,190.0 L522.7,169.7 L560.5,149.5 L598.2,120.6 L635.9,83.0 L673.6,54.1 L711.4,111.9 L749.1,207.3 L786.8,227.6 L824.5,213.1 L862.3,103.3 L900.0,129.3";
    const btcPath =
      "M70.0,275.6 L107.7,178.1 L145.5,181.8 L183.2,185.4 L220.9,60.4 L258.6,108.2 L296.4,137.6 L334.1,163.4 L371.8,174.4 L409.5,207.5 L447.3,189.1 L485.0,181.8 L522.7,167.1 L560.5,181.8 L598.2,192.8 L635.9,218.5 L673.6,236.9 L711.4,262.7 L749.1,303.1 L786.8,281.1 L824.5,288.4 L862.3,236.9 L900.0,247.2";
    const icpPath =
      "M70.0,275.6 L107.7,129.3 L145.5,225.7 L183.2,273.9 L220.9,257.9 L258.6,290.0 L296.4,306.1 L334.1,322.2 L371.8,338.2 L409.5,354.3 L447.3,354.3 L485.0,370.4 L522.7,418.6 L560.5,434.7 L598.2,434.7 L635.9,434.7 L673.6,428.2 L711.4,418.6 L749.1,434.7 L786.8,428.2 L824.5,418.6 L862.3,434.7 L900.0,441.7";
        ...
        >
          ...
          >
            ...
            >
              ...
              {/* Grid lines */}
              {[428.9, 377.8, 326.7, 224.4, 173.3, 122.2, 71.1, 20.0].map(
                (y) => (
                  <line
                    key={y}
                    x1="70"
          ...
          >
            ...
            >
              ...
              <div style={{ fontSize: 14, color: subLabel, marginTop: 4 }}>
                {fmtPrice(btcBase)} → {fmtPrice(btcNow)}
              </div>
            </div>
            <div
              style={{
            ...
            >
              ...
              <div style={{ fontSize: 14, color: subLabel, marginTop: 4 }}>
                {fmtPrice(gldtBase)} → {fmtPrice(gldtNow)}
              </div>
            </div>
            <div
              style={{
            ...
            >
              ...
              <div style={{ fontSize: 14, color: subLabel, marginTop: 4 }}>
                {fmtPrice(icpBase)} → {fmtPrice(icpNow)}
              </div>
            </div>
          </div>
          {/* Footer */}
  ...
  return (
    <div className="rounded-xl border border-border bg-card shadow-subtle overflow-hidden">
      ...
      >
        ...
        >
          {tab === "gold-data" && (
            <GoldDataTerminal ref={termRef} data={data} theme={theme} />
          )}
          {tab === "status" && (
            <GldtStatusTerminal ref={termRef} data={data} theme={theme} />
          )}
          {tab === "performance" && (
            <PerformanceTerminal ref={termRef} data={data} theme={theme} />
          )}
        </div>
      </div>
    </div>
